...
var baseConfig = {
  module: {
    destBasePath: path.resolve(__dirname, '../../src/pages'),
    templatePath: path.resolve(__dirname, '../../src/pages/dev-example'),
...
config.getUpdateData = function(mode, data) {
  if (mode === 'module') {
    return [{
      path: path.resolve(__dirname, '../webpack.base.conf.js'),
      position: {
        name: 'entry',
      ...
      path: path.resolve(__dirname, '../../src/common/menu.js'),
      position: {
        name: 'menu',
  ...
  if (mode === 'page') {
    return [{
      path: path.resolve(__dirname, '../../src/pages', data.moduleName, 'router/index.js'),
      position: {
        name: 'routes',
        type: 'ArrayExpression',
        only: true,
      ...
      path: path.resolve(__dirname, '../../src/pages', data.moduleName, 'store/index.js'),
      position: {
        name: 'modules',
        type: 'ObjectExpression',
        only: true,
      ...
      path: path.resolve(__dirname, '../../src/pages', data.moduleName, 'api/index.js'),
      position: {
        type: 'Program',
      },
